import { Bookmark, Building2, Building, Calendar, MapPin} from 'lucide-react'
   ...
   >
      <div className='flex items-start justify-between mb-4'>
        <div className='flex items-start gap-4'>
          ...
          <div className='flex-1'>
            ...
            <p className='text-gray-600 text-sm items-center gap2 mt-1'>
      ...
      <div className='flex items-center justify-between'>
        ...
        {job?.applicationStatus ? (
          ...
          !hideApply && (
            <button
              className='bg-gradient-to-r from-blue-50 text-sm text-blue-700 hover:text-white px-6 py-2.5 rounded-xl hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform hover:-translate-y-0.5'
              onClick={(e) => {
                e.stopPropagation();
                onApply();
              }}
