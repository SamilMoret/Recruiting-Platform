...
const ManageJobs = () => {
  ...
  const filteredAndSortedJobs = useMemo(() => {
    ...
    //sort jobs
    filtered.sort((a, b) => {
      let aValue = a[shortField];
      let bValue = b[shortField];

      if(shortField === "applicants"){
                                ...
                                <td className='px-6 py-5 whitespace-nowrap text-sm font-medium min-w-[180px] sm:min-w-0'>
                                  <div className='flex space-x-2'>
                                    ...
                                    <button
                                      ...
                                      onClick={() => handleDeleteJob(job.id, console.log(job.id))}
                                    >
                            ...
                            (page) => (
                              <button
                                ...
                                className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${
                                  currentPage === page
                                    ? "z-10 bg-blue-50 border-blue-500 text-shadow-blue-600"
                                    : "bg-white border-gray-300 text-gray-700 hover:bg-gray-500"
                                }`}
                              >
                                {page}
                              </button>
