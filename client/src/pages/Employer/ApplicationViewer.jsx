...
const ApplicationViewer = () => {
  ...
  return (
    <DashBoardLayout activeMenu='application-viewer'>
      {loading && (
      ...
      <div className='min-h-screen bg-gray-50'>
        ...
        {/* Main Content */}
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 pb-8'>
                  ...
                  <div className='p-6'>
                    <div className='space-y-4'>
                      {applications.map((application) => (
                        <div
                          key={application._id}
                          className='flex flex-col md:flex-row md:items-center md:justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors'
                        >
                          <div className=''>
                            {/* Avatar */}
