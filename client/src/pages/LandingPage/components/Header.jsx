...
const Header = () => {
  ...
  React.useEffect(() => {
    document.title = t('header.title', 'Recruiting Platform');
  }, [t]);
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-gray-900">{t('header.title', 'Recruiting Platform')}</span>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a
              ...
              className="text-gray-600 hover:text-gray-900 transition-colors font-medium bg-transparent border-none cursor-pointer"
            >
              {t('header.forEmployers', 'For Employers')}
            </a>
          </nav>
          <a
            ...
            className="text-gray-600 hover:text-gray-900 transition-colors font-medium bg-transparent border-none cursor-pointer"
          >
            {t('header.discoverTalent', 'Discover Talent')}
          </a>
          {/* Auth Buttons */}
          <div>
            {isAuthenticated ? (
              <div className="flex items-center space-x-3">
                <span>{t('header.hello', 'Hello')}, {user?.fullName}</span>
                <a
                  href={
                    user?.role === "admin"
                      ? "/admin-dashboard"
